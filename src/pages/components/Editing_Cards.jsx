...
function EditableCard({ imgUrl, deleteP, proTitle, dicrib, price, editPath}) {
    ...
    <div className="col-lg-3 col-md-4 col-sm-6" style={{margin:'1rem'}}>
            ...
            <a href={deleteP} class="btn btn-primary" style={{width: "8rem"}}>Delete</a>
            </div>
            <div>
            <a href={editPath} class="btn btn-primary" style={{width: "8rem"}}>Edit</a>
            </div>
            </div>
        </div>
    </div>
